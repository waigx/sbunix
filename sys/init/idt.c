...
void _set_isr_table(void)
{
	...
	_set_idt_entry(&entry[1], isr1, IDT_SEGMENT, IDT_DPL0 | IDT_P | IDT_INTERRUPT_TYPE);
	_set_idt_entry(&entry[2], isr2, IDT_SEGMENT, IDT_DPL0 | IDT_P | IDT_INTERRUPT_TYPE);
	_set_idt_entry(&entry[3], isr3, IDT_SEGMENT, IDT_DPL0 | IDT_P | IDT_INTERRUPT_TYPE);
	_set_idt_entry(&entry[4], isr4, IDT_SEGMENT, IDT_DPL0 | IDT_P | IDT_INTERRUPT_TYPE);
	_set_idt_entry(&entry[5], isr5, IDT_SEGMENT, IDT_DPL0 | IDT_P | IDT_INTERRUPT_TYPE);
	_set_idt_entry(&entry[6], isr6, IDT_SEGMENT, IDT_DPL0 | IDT_P | IDT_INTERRUPT_TYPE);
	_set_idt_entry(&entry[7], isr7, IDT_SEGMENT, IDT_DPL0 | IDT_P | IDT_INTERRUPT_TYPE);
	_set_idt_entry(&entry[8], isr8, IDT_SEGMENT, IDT_DPL0 | IDT_P | IDT_INTERRUPT_TYPE);
	_set_idt_entry(&entry[9], isr9, IDT_SEGMENT, IDT_DPL0 | IDT_P | IDT_INTERRUPT_TYPE);
	_set_idt_entry(&entry[10], isr10, IDT_SEGMENT, IDT_DPL0 | IDT_P | IDT_INTERRUPT_TYPE);
	_set_idt_entry(&entry[11], isr11, IDT_SEGMENT, IDT_DPL0 | IDT_P | IDT_INTERRUPT_TYPE);
